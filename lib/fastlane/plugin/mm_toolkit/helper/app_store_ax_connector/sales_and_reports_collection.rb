...
class SalesAndReportsCollection
  ...
  # For more information about types you go https://developer.apple.com/help/app-store-connect/reference/product-type-identifiers/
  FREE_OR_PAID_APP = "1F"
  ...
  def initialize(file)
    ...
    @items = csv_data.map do |content|
      SalesAndReports.new(
        content["Provider"],
        content["Provider Country"],
        content["SKU"],
        content["Developer"],
        content["Title"],
        content["Version"],
        content["Product Type Identifier"],
        content["Units"],
        content["Developer Proceeds"],
        content["Begin Date"],
        content["End Date"],
        content["Customer Currency"],
        content["Country Code"],
        content["Currency of Proceeds"],
        content["Apple Identifier"],
        content["Customer Price"],
        content["Promo Code"],
        content["Parent Identifier"],
        ...
        content["Proceeds Reason"],
        content["Preserved Pricing"],
        content["Client"],
        content["Order Type"],
      )
    end
