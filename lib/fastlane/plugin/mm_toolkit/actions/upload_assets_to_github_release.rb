      ...
      def self.available_options
        [
          ...
          FastlaneCore::ConfigItem.new(key: :server_url,
            ...
            optional: true,
            verify_block: proc do |value|
              UI.user_error!("Include the protocol in the server url, e.g. https://your.github.server") unless value.include?("//")
            end),
          ...
          FastlaneCore::ConfigItem.new(key: :api_bearer,
            ...
            code_gen_sensitive: true,
            description:
              "Use a Bearer authorization token. Usually generated by Github Apps, e.g. GitHub Actions GITHUB_TOKEN environment "\
              "variable",
